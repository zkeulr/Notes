...
We can use the definition of instantaneous 
power to find the power absorbed for AC sources. 
\[p(t) = v(t)i(t)\]
Recall also from your calculus courses that 
...
\begin{align*}
    p(t) &= i(t)v(t) \\
    &= (I_m \cos(\omega t + \theta_i)) (V_m \cos(\omega t +theta_v)) \\
...
Capacitors and inductors don't ever absorb power, although they do have impedance. 
