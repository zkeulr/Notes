...
is always positive) and $F_a$ is the flux of the particle. 
...
% Those differential equations are probably a good thing to put in here

The potential difference across the device 
caused by this eletric field is called 
