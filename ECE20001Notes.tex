...
ratio of the phasor voltage over the phasor current of an element. It is
...
Kirchhoff's voltage and current laws are still valid in the phasor domain. 
%be cool to give a worked example here, hw has some good ones
\end{document}
