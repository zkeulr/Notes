...
\section{Thevenin and Norton equivalent}
These terms describe two different ways of finding a simplified equivalent 2-terminal linear network.

\defn{Thevenin equivalent}{Thevenin's theorem states that it 
...
\begin{figure}
    ...
    \label{fig:thevenin}
    \begin{circuitikz}[american currents, american voltages]
        \draw (0,0) to[V, l_=$V_{s}$] (0,3) coordinate (a1)
            to[R, l=$R_s$, -o] ++(2,0) coordinate (a2);
        \draw (0,0) to[short, -o] (2,0);
    \end{circuitikz}
\end{figure}

\defn{Norton equivalent}{Norton's theorem states that any 
