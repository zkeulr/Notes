...
Despite the fancy name, we can think of eletric potential the 
...
in order to find electric potential energy (what's the potential energy 
of something floating around by itself in space? The question
make no sense, since potential energy is defined as a difference 
between two states). In the simplest case, 
