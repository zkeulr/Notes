...
\begin{enumerate}
    ...
    \item Electric field from dipole-induced dipole: $\left(\frac{1}{4\pi \epsilon_0}\right)^2 \frac{4 \alpha q p_1}{r^7}$
\end{enumerate}
...
\end{align*}
With a bit more algebraic simplification, we can show that
