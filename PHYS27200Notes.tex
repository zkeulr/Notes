...
\begin{enumerate}
    ...
    \item Electron current: $i = nA\bar{v}$
\end{enumerate}
...
I have previously said that a moving eletric charge produces a magnetic field. 
...
\[\vec{B} = \frac{\mu_0}{4 \pi}\frac{I \Delta l\times \hat{r}}{r^2}\]
