...
\subsection{Afghanistan War}

The Taliban is an Afghan militant movement
that emerged from the Afghan Civil War 
and, beginning in 1996, has controlled large areas 
of Afghanistan. Yet, despite their near-absolute 
control of the country by 2001, it took only weeks 
for the US and opposition forces to wrest control of 
Afghanistan in retaliation for the Taliban's support 
of Al-Qaeda. 

The Afghanistan War was the first war in which 
most munitions were precision guided. Its rapid 
success also seemed to lend credence to the belief 
that military action could cause regime change in 
the Middle East (although Afghanistan is in southeast 
Asia). Yet sweet victory turned bitter as the weeks
it took to conquer Afghanistan turned into decades of 
occupying it, and once the decision was made to withdraw, 
weeks for it to fall back into control of the Taliban. 
The war in Afghanistan was a costly, deadly failure. 
