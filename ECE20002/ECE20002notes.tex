...
However, there are some short cuts:
\begin{itemize}
    \item Constant input: the particular solution will be the input.
    \item Sinusiodal input: one can use SSS properties, and strategies like voltage
          division.
    \item Exponential input: no short cut, use ODE.
\end{itemize}
...
resistance of the inductor wire $R_s$, the capacitance between adjactent wires,
...
\end{center}
We will now learn to transform these configurations into more manageable and solveable configurations. \\
...
The same porcess can be conducted for capacitors:\\
\begin{align*}
