...
The non-ideal inductor, also known as a parasitic inductor, the non-ideal
inductor representation takes into account the resistance of the inductor wire
$R_s$, the capacitance between adjactent wires, and finally, the Ferrite Core
Loss, $R_p$, which consists of Eddy Current Loss and hysteresis loss.\\ Thus, a
full representation of an inductor, in terms of ideal elements, would be:
\begin{center}
    \begin{circuitikz}[american voltages, american currents]
        \draw (0,0)
        to[R, l=$R_s$] (0,2)
...
The same porcess is conducted for capacitors:\\
\begin{align*}
