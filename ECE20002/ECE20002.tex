...
$z_m$ are the \emph{zeroes}. The constant 
$K$ is called the \emph{gain constant}. 
Calling $z_m$ zeroes makes sense, but why 
...
changing the poles and zeroes of 
