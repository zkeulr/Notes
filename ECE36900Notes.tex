...
\begin{enumerate}
    \item Proof by deduction: say we wish to prove the product of two even integers is even. 
    ...
    \item Proof by contradiction: say we wish to prove $\sqrt{2}$ is irrational. In a theme
