...
\begin{enumerate}
    ...
    \item Direct proof (deduction)
    \item Indirect proof (contrapositive)
    \item Proof by contradiction
    \item Proof by induction
    \item 
\end{enumerate}
% add list of all proof techniques 
Say we wish to prove the product of two even integers is even. 
