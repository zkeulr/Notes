...
Predicate formulas are built by combining predicates with quantifers,
grouping symbols, and logical connectives seen before. 

For example: $(\forall x)(\exists y) x > y$. We would read this statment as 
