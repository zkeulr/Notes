...
\begin{multicols}{2}
    ...
    \begin{table*}[ht]
        ...
        \begin{tabular}{@{}llll@{}}
            ...
            $\frac{\sin\left(Wt\right)}{\pi t}$                            & $\begin{cases} 1, & |\omega| \le W \\ 0, & |\omega| > W \end{cases}$          & $\frac{\sin\left(Wn\right)}{\pi n}$                                     & $\begin{cases} 1, & 0 \leq |\omega| \le W \\ 0, & W < |\omega| \leq \pi \end{cases}$                                   \\ [1mm]
            \bottomrule
        \end{tabular}
    \end{table*}
