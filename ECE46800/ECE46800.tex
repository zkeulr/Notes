...
\title{Notes for ECE 46800 - Introduction to Compilers and Translation Engineering }
\author{Zeke Ulrich}
\date{\today} 
...
\include{chapters/phases}
\include{chapters/regex}
\include{chapters/automata}
\include{chapters/regexengines.tex}
\include{chapters/cfg}
