...
The scanner, parser, and semantic actions 
together are called the front end of a compiler. 
IR-level optimizations and code generation are the 
back end. You can make multiple front ends for a 
back end, and multiple back ends for a front end. 