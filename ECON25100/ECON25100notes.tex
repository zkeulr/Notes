          ...
          \begin{center}
              \begin{tikzpicture}[scale = 0.7]
                  \begin{axis}[
                      ...
                      {-3*x + 15};
                      \addplot [color=black, only marks] coordinates {(1,1) (2,2)};
                  \end{axis}
              \end{tikzpicture}
          \end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Substitutes-in-production: Alternate use of resources, goods that can be made with the same resources.
        \item Complements-in-production: Goods made together, like byproducts, or scrap usage.
    \end{itemize}
