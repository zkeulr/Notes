...
\begin{itemize}
    \item Demand $\uparrow$, Supply $\uparrow$: equilibrium price: (?), but equilibrium quantity: ($\uparrow$)
          \begin{center}
              \begin{tikzpicture}[scale = 0.5]
                  \begin{axis}[
                          axis lines = left,
              ...
              \end{tikzpicture}
          \end{center}
    \item Demand $\downarrow$, Supply $\downarrow$: equilibrium price: (?), but equilibrium quantity: ($\downarrow$)
          \begin{center}
              \begin{tikzpicture}[scale = 0.5]
                  \begin{axis}[
                          axis lines = left,
              ...
              \end{tikzpicture}
          \end{center}
    \item Demand $\uparrow$, Supply $\downarrow$: equilibrium price: ($\uparrow$), but equilibrium quantity: (?)
          \begin{center}
              \begin{tikzpicture}[scale = 0.5]
                  \begin{axis}[
                          axis lines = left,
...
\begin{enumerate}
    \item If price and quantity moves in same direction, demand has shifted.
    \item If price and quantity move in opposite directions, supply has shifted.
\end{enumerate}
\end{document}