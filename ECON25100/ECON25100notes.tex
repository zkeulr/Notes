...
\end{itemize}
If market price > equilibrium price, surplus will occur, and thus market forces will force the price to reach equiibrium.
...
\begin{center}
    \begin{tikzpicture}[scale = 0.7]
        \begin{axis}[
                ...
                ymin = 0,
                xmin = 0,
                legend entries = {supply, demand, surplus}
            ]
            \addplot [
                domain=1:5,
                samples=10,
